class Student:
    ...
    def calculate_result(self):
        ...
        # Summation or Sum of all the subject marks
        # Subject is the key and Marks is the value in Subjects dictionary
        # Subject:Marks
    ...
    def show_subject_details(self):
        print("RAW Format:", self.__subjects)
...
std1.show_subject_details()

# private data cannot be accessed directly, we can make a public method and access that
# std1.__total_marks # It will throw error

# So accessing through the method
std1.show_total_marks()

std2.show_total_marks()